...
// SRC_DIR 项目里src 路径
// STYPE_DEPS_JSON_FILE style 依赖
console.log('SRC_DIR, STYPE_DEPS_JSON_FILE: ', constant_1.SRC_DIR, constant_1.STYPE_DEPS_JSON_FILE);
function matchPath(path, component) {
    const p = path_1.relative(constant_1.SRC_DIR, path);
    //console.log("position path:", component, p, path_1.sep);
