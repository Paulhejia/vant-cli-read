...
// camelize 把 - 换成驼峰
// pascalizeRE // 把首字母换成大写
function pascalize(str) {
    return camelize(str).replace(pascalizeRE, (_, c1, c2) => { console.log(str, '  c1: ', c1, c2); return c1.toUpperCase() + c2; });
}
...
// 猜测是找用户的 webpack 配置然后合并
function getWebpackConfig() {
    console.log('去拿用户自己的webpack.config.js', constant_1.ROOT_WEBPACK_CONFIG_FILE);
